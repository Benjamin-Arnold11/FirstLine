...
def register():
    ...
    if request.method == "GET":
        ...
        if password != confirmation:
            return render_template("register.html", error="Password's Dont Match")
        if not username or not password or not confirmation:
            return render_template("register.html", error="Fill Out All Parts Of The Form")
